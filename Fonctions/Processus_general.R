...
setwd("~/Dropbox/2019-2020/Stage/Test/")
...
# Annotation : 
annotation_udpipe(path = "~/Dropbox/2019-2020/Stage/Zola/", 
                  model = "~/Dropbox/2019-2020/Stage/french-gsd-ud-2.4-190531.udpipe")


# Transformation en motifs UDPipe
regex_corpus_entier_UDPipe(path = "~/Dropbox/2019-2020/Stage/Test/", 
...
# Wordcloud : 
motifs_nuage(path = "~/Dropbox/2019-2020/Stage/Corpus/", csv = "Corpus_motifs_UDPipe.csv", nmots = 50)

# TF-IDF :
tf_idf_motifs(path = "~/Dropbox/2019-2020/Stage/Corpus/", csv = "Corpus_motifs_UDPipe.csv",
              nombre_motifs = 30)

# AFC :
motifs_afc(path = "~/Dropbox/2019-2020/Stage/Test/", csv = "Corpus_motifs_UDPipe.csv", 
           nombre_oeuvres = 4, nmotifs = 30, nombre_dimensions = 5)
...
# Barycentres : 
barycentre(path = "~/Dropbox/2019-2020/Stage/Corpus/", csv = "Corpus_motifs_UDPipe.csv")
