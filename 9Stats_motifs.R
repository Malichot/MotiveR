...
# Entrée : sortie du script de regex ou dataframe : mots | motifs | Oeuvre.
# Sortie : Motifs_statistisques.csv avec : Oeuvre | motifs | n (fréq absolue) | nb_total_mots (dans l'oeuvre) | n_rel (fréquence relative) 
# | spécificités oeuvre par oeuvre | n_total (fréquence total du motif dans le corpus) | barycentre 
...
stats_motifs(path = "~/Dropbox/2019-2020/Stage/Test_Regex_R/", csv = "Corpus_motifs_UDPipe.csv")
